...
# Optional: Remove STATICFILES_DIRS if you're using Docker and collectstatic
# STATICFILES_DIRS = [os.path.join(BASE_DIR, "static")]  # ❌ REMOVE THIS LINE

# Quick-start development settings - unsuitable for production
# See https://docs.djangoproject.com/en/5.1/howto/deployment/checklist/

# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = 'django-insecure-x9%a@zlxut0s4n!mi(dbg!0+qvfpaz3o$$5*!9g(mx!ga7=)u^'
